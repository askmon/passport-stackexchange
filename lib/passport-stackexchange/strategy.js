...
Strategy.prototype.userProfile = function(accessToken, done) {
    var url = "https://api.stackexchange.com/2.3/me?site=stackoverflow&key=" + this._options.key + "&team=" + this._options.team;
    ...
    request({ url: url, headers: {'accept-encoding': 'gzip', 'X-API-Access-Token': accessToken}})
